...
async function interrogateAll(session, monitorId) {
  ...
  const VCP_CODES = [
    ...
    { name: 'redGain',      opPage: 0x00, opCode: 0x16 },
    { name: 'greenGain',    opPage: 0x00, opCode: 0x18 },
    { name: 'blueGain',     opPage: 0x00, opCode: 0x1A },
    { name: 'hPosition',    opPage: 0x00, opCode: 0x20 },
    { name: 'vPosition',    opPage: 0x00, opCode: 0x30 },
